...
def populate():
    ...
    django_pages = [
        ...
        {'title':'Django Rocks',
         'url':'http://www.djangorocks.com/', 'views':150},
        {'title':'How to Tango with Django',
         'url':'http://www.tangowithdjango.com/','views':180} ]
    
    other_pages = [
        {'title':'Bottle',
         'url':'http://bottlepy.org/docs/dev/','views':500},
        {'title':'Flask',
         'url':'http://flask.pocoo.org','views':800} ]
